...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Keycloak-ED8B00?style=for-the-badge&logo=keycloak&logoColor=white" alt="Keycloak">
...
|-----------------------|-----------------------------------------------------------------------------|
| **Core**              | Java 17, Spring Boot 3.4, Maven                                            |
...
```bash
git clone https://github.com/iamHareen/StockFlow.git
cd StockFlow/MicroServiceProject
````
